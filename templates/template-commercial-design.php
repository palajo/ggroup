<?php /* Template Name: Commercial Design Template */ ?>
<?php get_header(); ?>
    ...
    <section class="section gray double-padding">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <?php if (have_rows('commercial_navigation')): ?>
                        <ul class="nav project-navigation">
                            <?php while (have_rows('commercial_navigation')): the_row(); ?>
                                <li class="nav-item">
    ...
    <?php if (have_rows('commercial_blocks')):
        $i = 0;    
    ?>
        <?php while (have_rows('commercial_blocks')): the_row();
            $i++;
            $reverse = "";
